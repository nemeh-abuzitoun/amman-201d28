...
return [total,`${a} and ${b} and ${c} sum to ${sum},The product of ${a} and ${b} and ${c} is ${multiply}, ${total}.`];
}
...
function sumArray(a,b,c) { //eslint-disable-line
  ...
  let total=['a','b','c'];
  sum=a+b+c;
  return [total,`${a},${b},${c} was passed in as an array of numbers, and ${sum} is thier sum.`]
  }
...
function multiplyArray(a,b,c) { //eslint-disable-line
  ...
  let total=['a','b','c'];
  sum=a*b*c;
  return [total,`The numbers ${a},${b},${c} have a product of${sum}.`]
  }
...
function multiplyAnyArray(a,b,c,d,e) { //eslint-disable-line
  ...
  return [total,`The numbers ${a},${b},${c},${d},${e} have a product of${product}.`]
  }
